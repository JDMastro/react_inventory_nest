...
export class init1643689830694 implements MigrationInterface {
    name = 'init1643689830694'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "setting_status" ("id" SERIAL NOT NULL, "status_parent_id" integer NOT NULL, "status_child_id" integer NOT NULL, CONSTRAINT "PK_7ee39794a8063248821af4b1b3b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "kind_movements" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "user_id" integer NOT NULL, "classificationpeople_id" integer NOT NULL, "require_consecutive" boolean NOT NULL DEFAULT false, "creation_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(3) NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "delete_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "status_id" integer NOT NULL, "classification_kindmovement_id" integer NOT NULL, "consecutive_id" integer, CONSTRAINT "PK_7690167c46ca89b0b5cb1ba6b52" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "classification_people" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_26750413d56cf00336039881738" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "roles" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "idx_roles_" UNIQUE ("name"), CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "client_manufacturer" ADD CONSTRAINT "FK_6aceff9e0cb9f6e37dc4a151b38" FOREIGN KEY ("manufacturer_id") REFERENCES "person"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_manufacturer" ADD CONSTRAINT "FK_7b35c3363294073fab6e895748a" FOREIGN KEY ("client_id") REFERENCES "person"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "person" ADD CONSTRAINT "FK_f7f4fe61e7b332647aec7212dfc" FOREIGN KEY ("classificationpeople_id") REFERENCES "classification_people"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "setting_status" ADD CONSTRAINT "FK_06e3863c409af19e083cb268653" FOREIGN KEY ("status_parent_id") REFERENCES "status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "setting_status" ADD CONSTRAINT "FK_aceca231fe6bc4a45b38fb96e6a" FOREIGN KEY ("status_child_id") REFERENCES "status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "kind_movements" ADD CONSTRAINT "FK_c42f6dda5379cefba1831832398" FOREIGN KEY ("classificationpeople_id") REFERENCES "classification_people"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "kind_movements" DROP CONSTRAINT "FK_c42f6dda5379cefba1831832398"`);
        await queryRunner.query(`ALTER TABLE "setting_status" DROP CONSTRAINT "FK_aceca231fe6bc4a45b38fb96e6a"`);
        await queryRunner.query(`ALTER TABLE "setting_status" DROP CONSTRAINT "FK_06e3863c409af19e083cb268653"`);
        ...
        await queryRunner.query(`ALTER TABLE "person" DROP CONSTRAINT "FK_f7f4fe61e7b332647aec7212dfc"`);
        await queryRunner.query(`ALTER TABLE "person" DROP CONSTRAINT "FK_0e4c050597bca13d5c70a79ff6e"`);
        await queryRunner.query(`ALTER TABLE "client_manufacturer" DROP CONSTRAINT "FK_7b35c3363294073fab6e895748a"`);
        await queryRunner.query(`ALTER TABLE "client_manufacturer" DROP CONSTRAINT "FK_6aceff9e0cb9f6e37dc4a151b38"`);
        ...
        await queryRunner.query(`DROP TABLE "classification_people"`);
        ...
        await queryRunner.query(`DROP TABLE "setting_status"`);
        await queryRunner.query(`DROP TABLE "movements"`);
        await queryRunner.query(`DROP TABLE "header"`);
        await queryRunner.query(`DROP TABLE "person"`);
        await queryRunner.query(`DROP TABLE "client_manufacturer"`);
