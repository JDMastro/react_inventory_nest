...
export class init1640107898319 implements MigrationInterface {
    name = 'init1640107898319'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movements" ("id" SERIAL NOT NULL, "product_id" integer NOT NULL, "quantity" double precision NOT NULL, "total_purchasePrice" double precision NOT NULL, "unit_price" double precision NOT NULL, "header_id" integer NOT NULL, "quantity_returned" double precision NOT NULL, "status_id" integer NOT NULL, "suggest" boolean NOT NULL DEFAULT false, "suggest_units" double precision NOT NULL DEFAULT '0', "suggest_generated" double precision NOT NULL DEFAULT '0', "amount_used" double precision NOT NULL DEFAULT '0', "waste_quantity" double precision NOT NULL DEFAULT '0', CONSTRAINT "PK_5a8e3da15ab8f2ce353e7f58f67" PRIMARY KEY ("id"))`);
