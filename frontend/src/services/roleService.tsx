...
{
    getAll: async (queryParameters: any) => await Requests.getAll(urlFormatRest(`roles`, queryParameters)),
    create: async (body: any) => await Requests.create(`roles`, body),
    update: async (id:number, body: any) => await Requests.update(`roles/${id}`, body),
    delete: async (id:number) => await Requests.delete(`roles/${id}`)
