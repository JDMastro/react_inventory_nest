    ...
    return (
        <Box sx={{ '& > :not(style)': { m: 1 } }}>
            ...
            <AlertDialogUi
                ...
                content={<UpdateUser kindId={kindId} handleClose={handleCloseModalUpdate} setRefresh={setRefresh} refresh={refresh} data={data} />}
            ...
            <AlertDialogUi
                ...
                content={<AddUsers kindId={kindId} refresh={refresh} setRefresh={setRefresh} handleClose={handleCloseModalAdd} />}
                open={openModalAdd}
                title=""
            />
        </Box>
