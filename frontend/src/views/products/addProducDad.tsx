...
export function AddProductDad({ handleClose, units, setRefresh, refresh }: any) {
    ...
    const onSubmit = async (values: initialFValuesTypes, formikHelpers: FormikHelpers<any>) => {
        setdisablebtn(true)
        try {
            const res = await ProductsRequest.create({
    ...
    const formik = UseForm(initialValuesProductDad, ProductsDadSchema, onSubmit)
