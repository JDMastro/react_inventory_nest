...
import { initialValuesSettinsStatus } from "../../initialValues";
...
export function AddSettingsStatus({ onClose, onSubmit: on, status }: any) {
    ...
    const onSubmit = async (values: initialFValuesTypes, formikHelpers: FormikHelpers<any>) => {
        ...
        try {
            const res = await SettingsStatusRequest.create({
    ...
    const formik = UseForm(initialValuesSettinsStatus, SettingStatusnSchema, onSubmit)
