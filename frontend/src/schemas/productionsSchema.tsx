...
export const ProductionsWithQuantityToUsedSchema: initialFValuesTypes = yup.object({
    ...
    amount_to_take : yup.number().positive().required("Este campo es requerido"),
    total_amount_used : yup.number().positive().required("Este campo es requerido").test({
    ...
    waste_quantity : yup.number().moreThan(-1).required("Este campo es requerido").test({
